...
public interface DiskInterface {
	 ...
	 * 
	 * @param buffer
	 *            reprezinta bufferul din care se scrie blocul
	 * @param blockNum
	 *            reprezinta numarul blocului ce urmeaza a fi scris
	 * @Daca buffer nu are dimensiunea BLOCK_SIZE sau indexul blocului este
	 *       eronat, metoda trebuie sa arunce exceptia BadBlockException
	 */
	public void writeBlock(byte[] buffer, int blockNum)
	 ...
	 * 
	 * @param blockNum
	 *            reprezinta numarul blocului ce urmeaza a fi citit
	 * @metoda returneaza continutul blocului citit
	 * @Daca indexul blocului este eronat, metoda trebuie sa arunce exceptia
	 *       BadBlockException
	 */
